...
var host = "34.82.39.91";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "llemon1llemon1";  //password (change to match your db, yes this is very poor practice)
